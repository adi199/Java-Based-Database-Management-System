...
import edu.ottawa.extensions.DBSupportedDataType;
import edu.ottawa.extensions.WhereConditionProcessor;
import edu.ottawa.extensions.TableInfoHandler;
...
public class Utils {
    ...
    public static WhereConditionProcessor fetchCndtFrmQuery(TableInfoHandler tableMetaData, String query) throws Exception {
